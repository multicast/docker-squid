...
# Packages
    ...
    ii  squid                         4.6-1+deb10u9               amd64        Full featured Web Proxy cache (HTTP proxy)
    ii  squid-common                  4.6-1+deb10u9               all          Full featured Web Proxy cache (HTTP proxy) - common files
