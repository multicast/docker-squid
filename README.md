...
# Packages
    ...
    ii  squid                         4.6-1+deb10u3               amd64        Full featured Web Proxy cache (HTTP proxy)
    ii  squid-common                  4.6-1+deb10u3               all          Full featured Web Proxy cache (HTTP proxy) - common files
